...
function main() {
  ...
  expectContains('src/contracts/miniappParityContracts.ts', 'export type DashboardWorkflowStatus = \'aligned\' | \'partial\' | \'dashboard-composed\' | \'shell-only\';');
  expectContains('src/contracts/miniappParityContracts.ts', 'export const DASHBOARD_PAGE_WORKFLOW_CONTRACTS');
  expectContains('src/contracts/miniappParityContracts.ts', 'export const DASHBOARD_MODULE_PAGE_WORKFLOW_CONTRACTS');
  ...
  expectContains('src/contracts/miniappParityContracts.ts', "pageComponent: 'AdminDashboardPage'");
  expectContains('src/contracts/miniappParityContracts.ts', "pageComponent: 'OpsDashboardPage'");
  expectContains('src/contracts/miniappParityContracts.ts', "pageComponent: 'SmsSenderPage'");
  expectContains('src/contracts/miniappParityContracts.ts', "pageComponent: 'ProviderControlPage'");
  expectContains('src/contracts/miniappParityContracts.ts', "pageComponent: 'AuditIncidentsPage'");
  expectContains('src/contracts/miniappParityContracts.ts', "workflowStatus: 'shell-only'");
  expectContains('src/contracts/miniappParityContracts.ts', "workflowStatus: 'dashboard-composed'");
  expectContains('src/contracts/miniappParityContracts.ts', "workflowStatus: 'aligned'");
  expectContains('src/contracts/miniappParityContracts.ts', "workflowStatus: 'partial'");
  expectContains('src/contracts/miniappParityContracts.ts', "canonicalCommand: BOT_PRIMARY_COMMANDS.STATUS");
  expectContains('src/contracts/miniappParityContracts.ts', "canonicalCommand: BOT_PRIMARY_COMMANDS.SMSSENDER");
  expectContains('src/contracts/miniappParityContracts.ts', "canonicalCommand: BOT_PRIMARY_COMMANDS.PROVIDER");
  expectContains('src/contracts/miniappParityContracts.ts', "canonicalCommand: BOT_PRIMARY_COMMANDS.ADMIN");
  expectContains('src/contracts/miniappParityContracts.ts', "path: DASHBOARD_MODULE_ROUTE_CONTRACTS.ops");
  expectContains('src/contracts/miniappParityContracts.ts', "path: DASHBOARD_MODULE_ROUTE_CONTRACTS.sms");
  expectContains('src/contracts/miniappParityContracts.ts', "path: DASHBOARD_MODULE_ROUTE_CONTRACTS.provider");
  expectContains('src/contracts/miniappParityContracts.ts', "path: DASHBOARD_MODULE_ROUTE_CONTRACTS.audit");
  ...
  expectContains('src/pages/AdminDashboard/dashboardShellConfig.ts', 'DASHBOARD_MODULE_PAGE_WORKFLOW_CONTRACTS');
  expectContains('src/pages/AdminDashboard/dashboardShellConfig.ts', 'type DashboardWorkflowStatus');
  expectContains('src/pages/AdminDashboard/dashboardShellConfig.ts', 'pageComponent: string;');
  expectContains('src/pages/AdminDashboard/dashboardShellConfig.ts', 'workflowStatus: DashboardWorkflowStatus;');
  expectContains('src/pages/AdminDashboard/dashboardShellConfig.ts', 'command: DASHBOARD_MODULE_PAGE_WORKFLOW_CONTRACTS[moduleId].canonicalCommand');
  expectContains('src/pages/AdminDashboard/dashboardShellConfig.ts', 'pageComponent: DASHBOARD_MODULE_PAGE_WORKFLOW_CONTRACTS[moduleId].pageComponent');
  expectContains('src/pages/AdminDashboard/dashboardShellConfig.ts', 'workflowStatus: DASHBOARD_MODULE_PAGE_WORKFLOW_CONTRACTS[moduleId].workflowStatus');
